...
void registerBuiltinFunctions(T)(VM!T vm) {
  vm.setBuiltins([
      ...
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, IntegerObject)("*")),
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, IntegerObject)("/")),
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, BooleanObject)(">")),
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, BooleanObject)("<")),
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, BooleanObject)(">=")),
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, BooleanObject)("<=")),
      mixin(generate_bin_arith!(IntegerObject, IntegerObject, BooleanObject)("==")),
      ...
      mixin(generate_bin_arith!(FloatObject, IntegerObject, FloatObject)("*")),
      mixin(generate_bin_arith!(FloatObject, IntegerObject, FloatObject)("/")),
      mixin(generate_bin_arith!(FloatObject, IntegerObject, BooleanObject)(">")),
      mixin(generate_bin_arith!(FloatObject, IntegerObject, BooleanObject)("<")),
      mixin(generate_bin_arith!(FloatObject, IntegerObject, BooleanObject)(">=")),
      mixin(generate_bin_arith!(FloatObject, IntegerObject, BooleanObject)("<=")),
      mixin(generate_bin_arith!(FloatObject, IntegerObject, BooleanObject)("==")),
      ...
      mixin(generate_bin_arith!(IntegerObject, FloatObject, FloatObject)("*")),
      mixin(generate_bin_arith!(IntegerObject, FloatObject, FloatObject)("/")),
      mixin(generate_bin_arith!(IntegerObject, FloatObject, BooleanObject)(">")),
      mixin(generate_bin_arith!(IntegerObject, FloatObject, BooleanObject)("<")),
      mixin(generate_bin_arith!(IntegerObject, FloatObject, BooleanObject)(">=")),
      mixin(generate_bin_arith!(IntegerObject, FloatObject, BooleanObject)("<=")),
      mixin(generate_bin_arith!(IntegerObject, FloatObject, BooleanObject)("==")),
      ...
      mixin(generate_bin_arith!(FloatObject, FloatObject, FloatObject)("*")),
      mixin(generate_bin_arith!(FloatObject, FloatObject, FloatObject)("/")),
      mixin(generate_bin_arith!(FloatObject, FloatObject, BooleanObject)(">")),
      mixin(generate_bin_arith!(FloatObject, FloatObject, BooleanObject)("<")),
      mixin(generate_bin_arith!(FloatObject, FloatObject, BooleanObject)(">=")),
      mixin(generate_bin_arith!(FloatObject, FloatObject, BooleanObject)("<=")),
      mixin(generate_bin_arith!(FloatObject, FloatObject, BooleanObject)("==")),
      ...
      mixin(generate_bin_arith!(StringObject, StringObject, BooleanObject)("==")),
      mixin(generate_bin_arith!(StringObject, StringObject, BooleanObject)("!=")),
  ]);
}
